...
export function GameCard({ game }: GameCardProps) {
  ...
  return (
    <TouchableOpacity className="w-[140px] mr-5 ml-2" onPress={handlePress}>
      <View className="relative mb-3 border-[1px] border-[#9146FF] rounded-2xl overflow-hidden">
        <Image 
        ...
        <View className="absolute bottom-2 left-2 bg-[rgba(145,70,255,0.9)] px-2 py-1 rounded-lg border border-[#9146FF]">
      ...
      <View className="px-1">
        ...
        <Text className="font-medium text-[11px] text-[#9146FF]">
          {game.genres && game.genres.length > 0 ? game.genres[0].name : 'Unknown'}
        </Text>
      </View>
    </TouchableOpacity>
